...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Complete Admin : Add a Song</title>
        ...
        <section class="wrapper main-wrapper row" style=''>
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        <!-- PAGE HEADING TAG - START --><h1 class="title">Add a Song</h1>
                    ...
                    <div class="pull-right hidden-xs">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="mus-song-add.html">Songs</a>
                            </li>
                            <li class="active">
                    ...
                    <header class="panel_header">
                        ...
                        <div class="actions panel_actions pull-right">
                            ...
                            <a class="box_setting fa fa-cog" data-toggle="modal"
                               href="mus-song-add.html#section-settings"></a>
                            <a class="box_close fa fa-times"></a>
                        </div>
                    </header>
                    <div class="content-body">
                        <div class="row">
                            <spring:form action="/saveMusic" modelAttribute="music" method="post"
                                ...
                                <div class="col-xs-12 col-sm-9 col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Song Artist</label>
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <spring:checkboxes path="artists" items="${artists}" itemLabel="name"/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">Song Album</label>
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <spring:select path="album" items="${albums}" itemLabel="name"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Song MP3 File</label>
                                        <div class="controls">
