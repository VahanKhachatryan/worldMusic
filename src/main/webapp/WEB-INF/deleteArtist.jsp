            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a class="active" href="/deleteArtist">Delete Artist</a>
                        </li>
                    </ul>
                </li>
                <li class="">
        ...
        <section class="wrapper main-wrapper row" style=''>
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        <!-- PAGE HEADING TAG - START --><h1 class="title">Delete Artist</h1>
                    ...
                    <div class="pull-right hidden-xs">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="mus-genres.html">Artist</a>
                            </li>
                            <li class="active">
                                    ...
                                    <div class="controls">
                                        <ul>
                                            <c:forEach items="${artists}" var="artist">
                                                <li><img  width="170" height="240" class="img-responsive" src="image?fileName=${artist.photo}">
                                                        ${artist.name} &nbsp; ${artist.surname} &nbsp; <a href="/artistDelete?artistId=${artist.id}">
