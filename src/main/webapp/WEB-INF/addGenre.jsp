...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Complete Admin : Add a Genre</title>
            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu" style='display:block;'>
                        ...
                        <li>
                            <a class="active" href="/addGenre">Add Genre</a>
                        </li>
                        <li>
                            <a class=""
        ...
        <section class="wrapper main-wrapper row" style=''>
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        <!-- PAGE HEADING TAG - START --><h1 class="title">Add a Genre</h1>
                    ...
                    <div class="pull-right hidden-xs">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="../adminpage/../adminpage/../adminpage/../adminpage/../adminpage/../adminpage/Java/Admin%20page/mus-genres.html">Genres</a>
                            </li>
                            <li class="active">
                    ...
                    <header class="panel_header">
                        ...
                        <div class="actions panel_actions pull-right">
                            ...
                            <a class="box_setting fa fa-cog" data-toggle="modal"
                               href="mus-genre-add.html#section-settings"></a>
                            <a class="box_close fa fa-times"></a>
                        </div>
                    </header>
                    <div class="content-body">
                        <div class="row">
                            <spring:form action="/saveGenre" method="get" modelAttribute="genre">
                                <div class="col-xs-12 col-sm-9 col-md-8">
                                    <div class="form-group">
                                        <label class="form-label" for="field-126381">Genre Name</label>
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <spring:input path="name" class="form-control" id="field-126381"/>
                                        </div>
                                    </div>
                                </div>
